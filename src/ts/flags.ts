...
const FLAG_NATIVE_RESOLUTION = true;
const FLAG_SPEARS_AS_LOOT = ENVIRONMENT != 'ultra';
...
const FLAG_FAST_LEVEL_GENERATION = ENVIRONMENT != 'ultra';
const FLAG_SCALE_WARM_UP_SPEED = ENVIRONMENT != 'ultra';
