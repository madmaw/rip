...
const CUBE_MAP_PERPSECTIVE_TRANSFORM = 
    matrix4Perspective(
        1,
        1,
...
const TARGET_HORIZONTAL_RESOLUTION = FLAG_NATIVE_RESOLUTION ? 0 : 800;
const TARGET_VERTICAL_RESOLUTION = FLAG_NATIVE_RESOLUTION ? 0 : 600;

const MAX_ATTACK_RADIUS = 1;
const DAMAGE_INVULNERABILITY_DURATION = 300;
const AI_RECALCULATION_TIME = 1e3;
const AI_LOOK_RADIUS = 2;
